...
export function Folder({ size = 20, className = "" }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function Warehouse({ size = 20, className = "" }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
      ...
      className={className}
    >
      <path d="M22 8.35V20a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V8.35A2 2 0 0 1 3.26 6.5l1-1.5A2 2 0 0 1 6.44 4h9.12a2 2 0 0 1 1.8 1.1L22 8.35zM7 12h10M7 16h10" />
    </svg>
  );
}

export function Code({ size = 20, className = "" }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function Plug({ size = 20, className = "" }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
      ...
      className={className}
    >
      <path d="M12 11a3 3 0 1 0-5.5 1.5" />
      <path d="M2 16h5l5-5-5-5H2v10z" />
      <path d="M16 16H9l3-4 4 4-3 3" />
    </svg>
  );
}

export function BarChart2({ size = 20, className = "" }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function RefreshCw({ size = 20, className = "" }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function Zap({ size = 20, className = "" }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function Leaf({ size = 20, className = "" }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M2 21c0-3 1-4.5 2.5-5.5C5 15 6 14 7 13" />
    </svg>
  );
}
...
export function AlertCircle({ size = 20, className = "" }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function TrendingUp({ size = 20, className = "" }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <polyline points="23 6 13.5 16.5 8.5 11.5 1 18" />
...
export function Settings({ size = 20, className = "" }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
